//! A simple Driver for the Waveshare 2.9" (B/C) V3 E-Ink Display via SPI
//!
...
//!
//!// Setup EPD
//!let mut epd = Epd2in9b::new(&mut spi, busy_in, dc, rst, &mut delay, None)?;
//!
...
//!let mut chromatic_display = Display2in9b::default();
//!
...
impl<SPI, BUSY, DC, RST, DELAY> WaveshareDisplayV2<SPI, DELAY>
    for Epd2in9b<SPI, BUSY, DC, RST, DELAY>
where
    SPI: SpiDevice,
    BUSY: InputPin,
